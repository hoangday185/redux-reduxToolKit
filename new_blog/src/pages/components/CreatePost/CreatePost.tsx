...
import { addPost, cancelEditingPost, finishedEditPost } from '../../blog/blog.slice'
...
const CreatePost = (): JSX.Element => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (editingPost) {
      dispatch(finishedEditPost(formData))
      return
    }
    ...
    <form onSubmit={handleSubmit} onReset={handleCancelEditingPost}>
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormDate((prev) => ({ ...prev, title: event.target.value }))}
        />
      </div>
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormDate((prev) => ({ ...prev, featuredImage: event.target.value }))}
        />
      </div>
      <div className='mb-6'>
        <div>
          ...
          <textarea
            ...
            onChange={(event) => setFormDate((prev) => ({ ...prev, description: event.target.value }))}
          />
        </div>
      </div>
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormDate((prev) => ({ ...prev, publishDate: event.target.value }))}
        />
      </div>
      <div className='mb-6 flex items-center'>
        <input
          ...
          onChange={(event) => setFormDate((prev) => ({ ...prev, published: event.target.checked }))}
        />
